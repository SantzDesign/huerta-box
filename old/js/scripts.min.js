/* Huerta Box built using TEMPBOX 1.2 - HTML5 boilerplate by Santz Design
------------------------------------------------------------*/
...
$('#contact-form').validate({
  ...
  submitHandler: function(form) {
    if( $('#contact-form').hasClass('sending') ) { return false; }
    $('#contact-form').addClass('sending');
    $('#contact-form .loading').show().addClass('show-me');
    $.ajax({
      type: "POST",
      ...
      success: function() {
        ...
        $('#contact-form .sent').show().addClass('show-me scale');
      }
    });
  }
});