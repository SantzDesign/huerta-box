...
$(function() {FastClick.attach(document.body);$('.navigation-item').smoothScroll({offset: -30});var swiper = new Swiper('#swiper', {slidesPerView: 'auto',centeredSlides: true,autoplay: 5000,loop: true});
$('#switch').bind('click', function(event) {event.preventDefault();if ( $('#switch').hasClass('is-summer') ) {$('#switch').removeClass('is-summer');$('#switch').addClass('is-winter');$('.box-list-summer').hide();$('.box-list-winter').show();} else {$('#switch').removeClass('is-winter');$('#switch').addClass('is-summer');$('.box-list-winter').hide();$('.box-list-summer').show();}});
});